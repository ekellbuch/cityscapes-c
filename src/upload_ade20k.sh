...
CLOUD_FOLDER_NAME="gs://ub-ekb/tensorflow_datasets/ad_e20k_corrupted/tfrecords/v.0.0/ade20k_corrupted"
MANUAL_DIR="${HOME}/tensorflow_datasets/ad_e20k_corrupted"
